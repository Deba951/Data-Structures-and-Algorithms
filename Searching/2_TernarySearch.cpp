...
// C++ program to illustrate recursive approach to ternary search Function to perform Ternary Search
...
/*
Time Complexity:    
O(log(3) n), 3 is base log base 3 n,  and  n is the size of the array.
Auxiliary Space:    O(1)
*/